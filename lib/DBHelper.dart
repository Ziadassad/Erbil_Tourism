...
class DBHelper{
  ...
  OnCreate(Database db , int version) async {
    ...
    String sqlHotel = "CREATE TABLE Hotel (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT , address TEXT , image TEXT , late REAL, lang REAL)";
    String sqlResturant = "CREATE TABLE Restuarant (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT , address TEXT , image TEXT , late REAL, lang REAL)";
    String sqlTourism = "CREATE TABLE Tourism (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT , address TEXT , image TEXT , late REAL, lang REAL)";
    String sqlShop = "CREATE TABLE Shop (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT , address TEXT , image TEXT , late REAL, lang REAL)";
    await db.execute(sqlHotel);
    await db.execute(sqlResturant);
    await db.execute(sqlTourism);
    await db.execute(sqlShop);
